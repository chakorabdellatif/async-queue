...
> [!NOTE]  
> Apache Kafka is fundamentally different from traditional message brokers like RabbitMQ. It is a **Distributed Event Streaming Platform**. Instead of a queue where messages are deleted after being read, Kafka acts as an **Append-Only Log**.
